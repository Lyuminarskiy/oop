...
- Возвращает информацию о координатах точки строкой вида `(x; y)`.
- Сравнивает точки между собой, возвращает булевское значение.
- Создаёт копию точки.
...
- Возвращает информацию о координатах вектора строкой вида
`[(x1; y1), (x2; y2)]`.
- Сравнивает векторы между собой, возвращает булевское значение.
- Создаёт копию вектора.
- Возвращает модуль вектора.
- Возвращает сумму двух векторов.
- Возвращает разность двух векторов.
- Возвращает результат скалярного произведения двух векторов.
- Возвращает результат умножения вектора на число.